...
const AI = (() => {
  ...
  function diagnoseLocally(snapshot) {
    ...
    const overTime = mock.所要分 > mock.制限分;
    ...
    return {
      ...
      nextActions: [
        ...
        overTime ? '短い模擬試験（20問15分）で時間内に解く練習をする' : '一つ上の級のレベルにも手を広げる'
      ],
  ...
  const SYSTEM_PROMPT = [
    ...
    '',
    '守ること:',
    '- 級の判定は「これまでの級別正答率」を主な根拠にする。解答数が少ない級は判断材料にしない。',
